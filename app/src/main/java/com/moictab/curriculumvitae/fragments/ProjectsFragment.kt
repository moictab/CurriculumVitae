...
class ProjectsFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
        ...
        activity.title = getString(R.string.projects_fragment_title)

        val projects = ProjectController().GetProjectsFromAssets(activity)
        ...
        adapter = ProjectsAdapter(projects!!, activity)
